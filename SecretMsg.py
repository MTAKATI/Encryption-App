...
def main_screen():
    ...
    #icon
    image_icon = PhotoImage(file="encryption1.png")
    ...
    Label(text="Enter text for encryption and decryption", fg="black", font=("calbri",16)).place(x=10, y=10)
    ...
    code=StringVar()
    Entry(width=19, textvariable=code, bd=0, font=("arial",25), show="*").place(x=10, y=200)
